...
export function CouponCardV2({ coupon }: Props): React.ReactElement {
  ...
  return (
    <article className="flex flex-col gap-3 rounded-2xl border border-border bg-surface p-4 shadow-sm transition hover:border-primary-300">
      <header className="flex items-start gap-3">
        {coupon.merchantLogo ? (
          ...
          <img
            ...
            alt={merchantName}
            className="size-12 shrink-0 rounded-xl bg-canvas object-contain p-1 ring-1 ring-border"
          />
        ) : (
          <div className="grid size-12 shrink-0 place-items-center rounded-xl bg-primary-50 text-base font-bold text-primary-700 ring-1 ring-border">
        ...
        {discountLabel ? (
          <span className="inline-flex items-center rounded-full bg-cta-50 px-2.5 py-1 text-sm font-bold text-cta-700 ring-1 ring-inset ring-cta-200">
            {discountLabel}
          </span>
        ) : null}
      </header>
      ...
      <div className="flex flex-col gap-2 border-t border-dashed border-border pt-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        {coupon.affiliateUrl ? (
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-full bg-cta-500 px-4 py-2 text-sm font-semibold text-ink shadow-sm transition hover:bg-cta-400"
          >
            Lấy mã &amp; mua →
          </a>
        ) : null}
