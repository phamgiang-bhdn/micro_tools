...
import { Tag, BadgeCheck, BadgeAlert } from "lucide-react";
import {
  adminGet,
  FilterBar,
  ListPageShell,
...
import { updateBrandDisplayNameAction } from "../actions";
...
export default async function BrandsPage({
  ...
  const path = `/admin/brands${qs.toString() ? `?${qs.toString()}` : ""}`;
